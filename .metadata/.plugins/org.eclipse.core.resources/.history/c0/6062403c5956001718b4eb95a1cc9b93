...
public class Frame1 {
	...
	private void initialize() {
		...
		JComboBox specialSk_comboBox_1 = new JComboBox();
		...
		JComboBox specialSk_comboBox_2 = new JComboBox();
		...
		JComboBox specialSk_comboBox_3 = new JComboBox();
		...
		JComboBox specialSk_comboBox_4 = new JComboBox();
		...
		JComboBox specialSk_comboBox_5 = new JComboBox();
